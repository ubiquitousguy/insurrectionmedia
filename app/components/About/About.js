    ...
    return (
      <div className="container" id="about">
        ...
        <div className="col-sm-4">
          <img style="width: 200px;" className="center-block img-responsive" src="public/assets/Kiliaen.jpg" />
        ...
        <div className="col-sm-4">
          <img style="width: 200px;" className="center-block img-responsive" src="public/assets/Deb.jpg" />
        ...
        <div className="col-sm-4">
          <img style="width: 200px;" className="center-block img-responsive" src="public/assets/Jordana.jpg" />
