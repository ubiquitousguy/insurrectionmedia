      ...
      <div className="container" id="about">
        ...
        <div className="row partner-content">
          <div className="col-sm-8">
            <a href="http://www.skybound.com/">
              <img className="mx-auto d-block img-fluid partner-img grow" src="public/assets/skybound.png" style={imgStyle} />
            </a>
        ...
        <div className="row partner-content">
          <div className="offset-sm-4 col-sm-8">
            <a href="http://www.abominablepictures.com/">
              <img className="mx-auto d-block img-fluid partner-img grow" src="public/assets/abominable.png" />
            </a>
        ...
        <div className="row partner-content">
          <div className="col-sm-8">
            <a href="https://www.harpercollins.com/">
              <img className="mx-auto d-block img-fluid partner-img grow" src="public/assets/harpercollins.png" style={imgStyle} />
            </a>  
